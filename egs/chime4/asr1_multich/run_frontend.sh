...
train_dev=dt05_simu_isolated_6ch_track
train_test=et05_simu_isolated_6ch_track
recog_set="et05_simu_isolated_6ch_track"
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    # generate data_enh.json
    for dset in tr cv tt; do
        local/asr_json_to_ss_json.py \
            --asr-json data/${dset}_mix_both_anechoic_max_16k/data.json \
            --wav-scp data/${dset}_mix_both_anechoic_max_16k/wav.scp \
            --spk1-scp data/${dset}_mix_both_anechoic_max_16k/spk1.scp \
            --spk2-scp data/${dset}_mix_both_anechoic_max_16k/spk2.scp \
            > data/${dset}_mix_both_anechoic_max_16k/data_enh.json
    done
fi
