...
log_file=log/log.reverb.${jobname}.stage${stage}-${stop_stage}${use_vad_mask:+_vad_mask}${use_complex_mask:+_complexmask}${test_nmics:+_${test_nmics}ch}${enh_loss_type:+_${enh_loss_type}_loss}
