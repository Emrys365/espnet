...
train_set=tr_simu_8ch_multich_singlespkr
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    (
        ...
        #output_dir=evaluate_frontend/evalSDR${prefix}_oracle_PSM/${rtask}
        output_dir=evaluate_frontend/evalSDR${prefix}_${recog_model}_3iter/${rtask}
