...
if [[ "$task" == "0" ]]; then
    jobname=SMSmvdrComp_cisdr #ss_revb
    wpd_opt=
elif [[ "$task" == "1" ]]; then
    jobname=SSfront
...
#jobname=evalSS
#train_opt="${train_opt} --resume /mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/jsalt2020/espnet-v.0.7.0/egs/sms_wsj/asr1/exp_frontend/train_si284_pytorch_train_multispkr_mvdr_preprocess_lr0.0001_ci_sdr_loss_2chmse/results/snapshot.ep.50"
#train_opt="${train_opt} --resume /mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/jsalt2020/espnet-v.0.7.0/egs/sms_wsj/asr1/exp_frontend/train_si284_pytorch_train_multispkr_mvdr_atf_preprocess_lr0.0001_ci_sdr_loss_2chmse/results/snapshot.ep.50"
