...
# Time-Frequency mask
#train_opt="${train_opt} --resume /mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/jsalt2020/espnet-v.0.7.0/egs/whamr/asr1/exp/seed1_tr_mix_both_anechoic_reverb_max_16k_singlespkr2c_pytorch_train_multispkr_trans_wyz97_padertorch_mvdr_preprocess_uttcmvn_5taps_2021_05_21/results/snapshot.ep.60"
#train_opt="${train_opt} --resume /mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/jsalt2020/espnet-v.0.7.0/egs/whamr/asr1/exp/seed1_tr_mix_both_anechoic_reverb_max_16k_singlespkr2c_pytorch_train_multispkr_trans_wyz97_padertorch_mvdr_atf_preprocess_uttcmvn_5taps_2021_05_21/results/snapshot.ep.72"
train_opt="${train_opt} --resume /mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/jsalt2020/espnet-v.0.7.0/egs/whamr/asr1/exp/seed1_tr_mix_both_anechoic_reverb_max_16k_singlespkr2c_pytorch_train_multispkr_trans_wyz97_padertorch_mvdr_complex_preprocess_uttcmvn_5taps_2021_05_28/results/snapshot.ep.50"

# VAD-like mask
#train_opt="${train_opt} --resume /mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/jsalt2020/espnet-v.0.7.0/egs/whamr/asr1/exp/seed1_tr_mix_both_anechoic_reverb_max_16k_singlespkr2c_pytorch_train_multispkr_trans_wyz97_padertorch_mvdr_preprocess_uttcmvn_5taps_vad_mask_2021_05_21/results/snapshot.ep.81"
#train_opt="${train_opt} --resume /mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/jsalt2020/espnet-v.0.7.0/egs/whamr/asr1/exp/seed1_tr_mix_both_anechoic_reverb_max_16k_singlespkr2c_pytorch_train_multispkr_trans_wyz97_padertorch_mvdr_atf_preprocess_uttcmvn_5taps_vad_mask_2021_05_21/results/snapshot.ep.82"
...
#    jobname=mimo_maskfl
#    jobname=mimo_solver
    jobname=mimoComp_WHAMR
    #jobname=mimoCMVDRatf_WHAMR
    #jobname=mimoATF_WHAMR
    #jobname=rD2c
elif [[ "$task" == "3" ]]; then
    jobname=r_nara
elif [[ "$task" == "4" ]]; then
...
#-----------------------------------------------------------------------
    ...
    init_frontend=
    init_from_mdl=
###    init_asr='/mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/espnet-v0.5.3/multi-channel/wsj-mix-spatialized/exp_revb/seed1_tr_spatialized_reverb_multich_naraWPE3_singlespkr2c_pytorch_train_mvdr_wpe_trans_preprocess_globalcmvn_fromE5_5taps_2020_05_07/results/snapshot.ep.4'
###    init_frontend='/mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/espnet-v0.5.3/multi-channel/wsj-mix-spatialized/exp_revb/seed1_tr_spatialized_reverb_multich_naraWPE3_singlespkr2c_pytorch_train_mvdr_wpe_trans_preprocess_globalcmvn_fromE5_5taps_2020_05_07/results/snapshot.ep.4'
    ...
    #init_asr='/mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/espnet-v0.5.3/multi-channel/wsj-mix-spatialized/exp_revb/seed1_train_si284_pytorch_train_multispkr800_trans_wyz97_preprocess_wpd_ver5_globalcmvn_5taps_2020_05_07/results/snapshot.ep.50'
#    init_asr='/mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/espnet-v0.5.3/multi-channel/wsj-mix-spatialized/exp_revb/seed1_tr_spatialized_reverb_multich_singlespkr2c_pytorch_train_multispkr512_trans_wyz97_preprocess_init_asr_wpd_ver5_globalcmvn_5taps_2020_05_08/results/snapshot.ep.12'
    #init_frontend='/mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/espnet-v0.5.3/multi-channel/wsj-mix-spatialized/exp_revb/seed1_tr_spatialized_reverb_multich_singlespkr2c_pytorch_train_multispkr512_trans_wyz97_preprocess_init_asr_wpd_ver5_globalcmvn_5taps_2020_05_08/results/snapshot.ep.12'
#    init_from_mdl='/mnt/lustre/sjtu/users/wyz97/work_dir/wyz97/espnet-v0.5.3/multi-channel/wsj-mix-spatialized/exp_revb/seed1_tr_spatialized_reverb_multich_singlespkr2c_pytorch_train_mvdr_wpe_trans_preprocess_globalcmvn_fromE5_5taps_2020_05_06/results/model.loss.best'
    init_frontend=
    init_from_mdl=
else
    init_asr=
...
log_file=log/log.reverb.padertorch.wpe_mvdr${use_vad_mask:+.vad_mask}.${lr:+_lr$lr}_2c.seed${seed}.${jobname}.${use_transformer:+transformer.}stage${stage}-${stop_stage}
