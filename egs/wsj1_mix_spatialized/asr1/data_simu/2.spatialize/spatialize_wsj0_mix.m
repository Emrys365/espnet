...
function spatialize_wsj0_mix(num_speakers,min_or_max,fs,start_ind,stop_ind,useparcluster_with_ind,generate_rirs)
    ...
    data_in_root  = './wsj1-mix/'; % directory of the original wsj0-mix data
    rir_root      = './wsj1-mix/'; % directory to write the generated RIRs into
    data_out_root = './wsj1-mix/'; % directory to write the spatialized mixtures into
    ...
    NUM_UTT_IN_WSJ_MIX = 37416+503+333;
...
function spatialize_mix(rir_dir, start_ind, stop_ind, fs, data_in_root, data_out_root,num_speakers,min_or_max, useparcluster)
    ...
    for dd = 1 : length(datasets)
        ...
        flist = importdata(['wsj0-',num2str(num_speakers),'mix_',dataset,'.flist.mix']);        
