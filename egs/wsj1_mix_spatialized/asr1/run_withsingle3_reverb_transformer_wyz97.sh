...
expdir=exp_revb/seed${seed}_${expname}${multich_epochs:+_fromE$multich_epochs}_${chs}5taps${use_vad_mask:+_vad_mask}${bf_wpe_tag:+_tag_$bf_wpe_tag}_$(date +"%Y_%m_%d")
