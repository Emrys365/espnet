...
def get_rtf(
    ...
    Algorithm:
        rtf = psd_noise MaxEigVec[psd_noise^-1 @ psd_speech]
    Power iteration:
    ...
    if is_torch_1_9_plus and is_torch_complex_tensor(phi):
        print("Using torch.linalg.eig for RTF estimation", flush=True)
        rtf = torch.linalg.eig(phi).eigenvectors[..., :1]
