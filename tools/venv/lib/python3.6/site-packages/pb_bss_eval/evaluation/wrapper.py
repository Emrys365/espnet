...
class InputMetrics:
    ...
    @cached_property.cached_property
    def srmr(self):
        return pb_bss_eval.evaluation.srmr(self.observation, self.sample_rate)
...
class OutputMetrics:
    ...
    @cached_property.cached_property
    def srmr(self):
        return pb_bss_eval.evaluation.srmr(self.speech_prediction_selection, self.sample_rate)
